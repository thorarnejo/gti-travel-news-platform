...
export const sampleArticles: Article[] = [
  {
    ...
    body: [
      'Unite confirmed strike action among contracted ground operations teams, and Heathrow published live advisories while airlines issued service notices. From 15 March 00:01 to 17 March 23:59 GMT, reduced handler availability has slowed baggage throughput and aircraft turnaround cycles, creating rolling delays and selective cancellations.',
      'Operational impact is concentrated in Terminals 2 and 3, with knock-on effects across European and North American banks. Travelers with same-day connections, checked baggage, or tight transfer windows are seeing the highest disruption risk, especially during morning and evening peak waves.',
      'FAQ:\n\n**Q1: Should I still go to the airport if my app says delayed?**\nA: Yes, unless airline status shows cancelled, because desk cutoffs may move.\n\n**Q2: Will airlines pay hotels?**\nA: For eligible disruptions, many carriers reimburse reasonable costs with receipts, but policy differs by carrier and cause classification.\n\n**Q3: Can I switch airports?**\nA: In some fare classes yes, if your airline has approved protection via LGW/STN/LTN.',
    ],
    whatThisMeans: 'Expect delays even when flights still show as operating: slower baggage handling and terminal congestion can cause missed connections, extra transfer time, and higher rebooking or overnight costs; health risk remains low, but fatigue and stress rise quickly if you are displaced without a backup plan.',
    whatChanged: 'Latest Heathrow and union updates confirm reduced ground-handling capacity through 17 March 23:59 GMT, with T2/T3 still the main pressure point and continuing knock-on delays into onward European and North American departures.',
    whoIsAffected: 'Most affected are passengers departing or connecting via Heathrow T2/T3 during strike hours, especially economy and light-fare tickets with tighter change rules, travelers with checked bags, and same-day transfer itineraries across UK/Europe/North America.',
    whatToDo: '1) Recheck flight status, terminal, and check-in cutoff 6-8 hours before departure and again before leaving for the airport.\n2) If you connect at Heathrow, request protected rebooking now for a later bank or next-day option.\n3) Keep medication, chargers, documents, and one day of clothing in cabin baggage.\n4) Save waiver-policy screenshots and keep receipts for meals, transfers, and hotels.\n5) Ask about reroute options (LGW/MAN/direct alternatives) if your fare rules allow.\n\nACTION REQUIRED: Lock a protected fallback itinerary before afternoon peak congestion reduces seat availability.',
    sources: [
