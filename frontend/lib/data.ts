...
export const sampleArticles: Article[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'FAQ: Q1: Can I board with an application receipt only? A: Usually no, carriers expect approved status. Q2: How early should I apply? A: Minimum two weeks, ideally three in peak periods. Q3: Does this apply to every country? A: No, only designated passport markets listed by MOFA.',
    ],
